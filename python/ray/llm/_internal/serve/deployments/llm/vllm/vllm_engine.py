...
if TYPE_CHECKING:
    ...
    from vllm.entrypoints.openai.serving_scores import OpenAIServingScores
...
class VLLMEngine(LLMEngine):
    def __init__(
        ...
        self._oai_serving_scores: Optional["OpenAIServingScores"] = None
    ...
    def _validate_openai_serving_scores(self):
        assert (
            self._oai_serving_scores is not None
        ), "oai_serving_scores is not initialized"
        assert hasattr(
